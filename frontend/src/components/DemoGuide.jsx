...
const CLIENTS = [
  ...
  },
  {
    ...
    name: "Ethan Rhodes",
    emoji: "💻",
    tag: "Burnout · Imposter Syndrome · Student",
    color: "#e67e22",
    summary: "Junior CS major at a competitive state university. Middle-class background — parents are an engineer and an accountant who pushed academics hard. He was the 'smart one' growing up; now surrounded by peers who've been coding since age 12, and he's convinced he doesn't belong. Overcommitted, burned out, quietly falling apart.",
    context: [
      "Treatment goals: recognize burnout signals, challenge GPA = worth belief, build self-trust, define 'good enough'",
      "Diagnoses: Adjustment Disorder with anxiety features, Academic burnout · No medication",
      "Triggers: grades (especially when peers score higher), internship rejections, parents asking 'how's school', feeling out of depth in class",
      "Last session: named the 'I'll rest after this semester' pattern (been saying it since freshman year). Set one rule: if it's 85% done after 3+ hours, submit it.",
    ],
    chatDemo: "Try: \"I bombed an interview for an internship I really wanted. My roommate got an offer from Google and I can't even get a phone screen.\"",
    checkinNote: "Sliders: Stress (red at high) + Energy (green at high). Buttons: Academic habits + Self-care. Great for showing how the AI references Ethan's specific context — imposter syndrome, parental pressure, the 85% rule.",
  },
  {
    id: "client-004",
